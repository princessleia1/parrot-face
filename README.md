# Parrot-Face
**Parrot-Face** is a colourful clockface for Fitbit OS based on the [Parrot Linux OS](https://parrotlinux.org/) theme. **Parrot-Face** utilises [Fitbit OS SDK V3.1.0](https://github.com/Fitbit). 

## Features
- Digital clockface with Parrot Linux OS 'Macaw' background.
